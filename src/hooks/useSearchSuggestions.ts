      ...
      switch (key) {
        case "ArrowDown":
          setSelectedIndex((prev) => {
            ...
            return nextIndex < suggestions.products.length
              ? nextIndex
              : Math.min(prev + 1, suggestions.products.length - 1);
          });
          return "handled";
        case "ArrowUp":
          setSelectedIndex((prev) => {
        ...
        case "ArrowRight":
          setSelectedIndex((prev) =>
            prev < suggestions.products.length - 1 ? prev + 1 : prev
          );
          return "handled";
        case "Enter":
          if (
            selectedIndex >= 0 &&
            selectedIndex < suggestions.products.length
          ) {
