          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-2 md:p-10 shadow-xl border border-white/20">
              <p className="font-inter text-gray-700 leading-relaxed mb-8 text-lg">
                Cakes Wow is an FSSAI-certified bakery where every dessert tells
                a story! Our bakery came to light intending to make your
                remarkable occasions even sweeter and more memorable. We bake
                perfection with quality ingredients into impeccable cakes,
                pastries, brownies, cupcakes, and much more. We specialise in
                delivering exuberant smiles to our customers in around 30 cities
                across India, including Delhi, Mumbai, Bengaluru, Hyderabad,
                Ahmedabad, Chennai, Kolkata, Pune, and so forth. Cakes Wow is a
                haven for dessert lovers who want to indulge in scrumptious
                treats and fill their celebrations with cherished memories.
              </p>
              <button
          ...
          <div className="text-center">
            ...
            <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl p-8 max-w-3xl mx-auto border border-white/20 relative">
              ...
              <p className="text-gray-800 italic mb-6 text-xl leading-relaxed font-medium">
                "The cake was super delicious thank you. Amazing quality and
                taste, definitely ordering again!"
              </p>
