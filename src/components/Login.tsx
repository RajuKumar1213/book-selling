...
export default function Login({ setShowLogin, isVisible = true }: LoginProps) {
  ...
  return (
    ...
    >
      ...
      {/* Modal Content */}
      <div
        className={`w-full overflow-y-scroll h-full md:absolute md:top-1/2 md:left-1/2 md:transform md:-translate-x-1/2 md:-translate-y-1/2 md:w-[26rem] md:h-auto md:max-h-[85vh] bg-white md:bg-transparent md:rounded-lg md:overflow-visible flex flex-col ${
          isVisible ? "translate-y-0" : "translate-y-full md:translate-y-0"
        }`}
      >
        {/* Decorative Background - only on mobile */}
        {/* <div className="absolute inset-0 overflow-hidden pointer-events-none md:hidden">
          <div className="absolute -top-24 -left-24 w-96 h-96 bg-gradient-to-br from-blue-200/40 via-indigo-200/30 to-purple-200/40 rounded-full blur-3xl opacity-50"></div>
          <div className="absolute -bottom-24 -right-24 w-96 h-96 bg-gradient-to-br from-teal-200/40 via-blue-200/30 to-indigo-200/40 rounded-full blur-3xl opacity-50"></div>
        </div> */}
        ...
        <div className="flex-1 flex flex-col px-6 py-8 md:px-6 md:py-5 relative md:bg-white md:shadow-lg md:rounded-lg md:min-h-[30rem]">
          ...
          <div className="text-center pt-8 md:pt-3 pb-8 md:pb-4">
            <div className="w-20 h-20 md:hidden mx-auto bg-gradient-to-br from-blue-400 via-indigo-500 to-purple-500 rounded-full flex items-center justify-center shadow-xl mb-4 border-4 border-white/20">
              ...
              <div className="flex-1">
                ...
                {error.includes("phone number") && (
                  <div className="mt-2 text-xs text-red-600">
                    <p>
                      💡 <strong>Tip:</strong> Please enter a valid 10-digit
                ...
                {error.includes("Too many") && (
                  <div className="mt-2 text-xs text-red-600">
                    <p>
                      💡 <strong>Tip:</strong> Please wait a few minutes before
                      trying again to avoid rate limiting.
                    </p>
                  </div>
                )}
              </div>
            ...
            {step === 1 && (
              <div className="space-y-6 md:space-y-4">
                <div className="text-center">
                  <label
                    htmlFor="phone"
                    className="text-gray-700 text-base md:text-sm font-semibold mb-4 md:mb-3 flex items-center justify-center gap-2"
                  >
                  ...
                  <input
                    ...
                    className="w-full px-6 py-4 md:px-4 md:py-3 bg-gradient-to-br from-gray-50 to-white border-2 border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 text-lg md:text-base  font-medium focus:outline-none focus:ring-4 focus:ring-blue-500/20 focus:border-blue-500 shadow-sm hover:shadow-md transition-all duration-300"
                    required
                  />{" "}
              ...
              <div className="space-y-6 md:space-y-4">
                <div className="text-center">
                  <input
                    ...
                    placeholder="• • • • • •"
                    maxLength={6}
                    className="w-full px-6 py-4 md:px-4 md:py-3 bg-gradient-to-br from-gray-50 to-white border-2 border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 text-2xl md:text-lg text-center font-mono tracking-[0.3em] focus:outline-none focus:ring-4 focus:ring-blue-500/20 focus:border-blue-500 shadow-sm hover:shadow-md transition-all duration-300"
                    required
                  />{" "}
                ...
                <div className="flex items-center justify-between pt-2 md:pt-3">
                  ...
                  <button
                    ...
                    className={`font-semibold text-sm px-3 py-2 rounded-lg transition-all duration-200 ${
                      canResend && !loading
            ...
            <div className="max-w-sm mx-auto w-full">
              {step === 1 ? (
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-indigo-500 to-purple-500 hover:from-indigo-600 hover:to-purple-600 text-white py-4 md:py-3 px-6 rounded-xl text-lg md:text-base font-bold disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3 shadow-lg hover:shadow-xl transform hover:scale-[1.02] active:scale-[0.98] transition-all duration-300"
                >
                  {loading ? (
                    <>
                      <div className="w-5 h-5 border-2 border-white border-t-transparent rounded-full animate-spin"></div>
          ...
          <div className="text-center pb-2">
            <p className="text-gray-500 text-xs font-medium">
              ...
              <span className="text-gray-700 hover:text-blue-600 cursor-pointer font-semibold transition-colors duration-200">
                Terms
              </span>{" "}
              and{" "}
              <span className="text-gray-700 hover:text-blue-600 cursor-pointer font-semibold transition-colors duration-200">
