    ...
    <div className="bg-white rounded shadow-xl overflow-hidden">
      ...
      <div className="p-4 md:p-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
          <div className="group">            <label className="block text-xs md:text-sm font-medium text-gray-700 mb-2 transition-colors group-focus-within:text-orange-600">
            ...
            <div className="relative">            
              ...
              placeholder="Your name (e.g., Rajiv)"
            />
              <User
