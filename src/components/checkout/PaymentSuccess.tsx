        ...
        <div className="p-6 space-y-4">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-blue-700 text-sm leading-relaxed">
                  🎉 Thank you for your order! Your delicious cake will be
                  freshly prepared and delivered to you within the selected time
                  slot. You'll receive updates on your order status soon.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-50 rounded-xl p-4">
            ...
            <p className="text-sm text-gray-600">
              Contact us at{" "}
              <span className="font-medium text-blue-600">+91 9876543210</span>{" "}
              for any queries about your order.
            </p>
          </div>{" "}
          {/* Action Buttons */}
          <div className="space-y-3 pt-4">
            ...
            {notifications?.customer && (
              <button className="w-full bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white font-semibold py-3 px-4 rounded-xl transition-all duration-300 transform hover:scale-[1.02] shadow-lg hover:shadow-xl flex items-center justify-center gap-2">
