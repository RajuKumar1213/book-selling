...
export default function CategoriesManagement({
  ...
  const [sortBy, setSortBy] = useState<
    "name" | "group" | "created" | "displayOrder"
  >("displayOrder");
  ...
  const handleDeleteCategory = async (categoryId: string) => {
    if (
      !confirm(
        "Are you sure you want to delete this category? This will also remove it from all associated products."
      )
    )
      return;
  ...
  if (!categories.length && !categoriesLoading && !hasInitialLoad) {
    return (
